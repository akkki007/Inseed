...
const courses = [
  {
    ...
    description:
      "Learn about algorithms, data structures, and computer systems.",
    image: computerImage,
  },
  {
    name: "IT Engineering",
    description:
      "Focus on information systems, database management, and networking.",
    image: itImage,
  },
  {
  ...
  },
  {
    ...
    description:
      "Study electrical circuits, power systems, and control systems.",
    ...
    >
      <main className="flex-grow container mx-auto py-8 px-4">
        <section className="bg-white bg-opacity-75 p-6 rounded-lg shadow-lg mb-8 flex">
          ...
          <div className="flex-grow">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">
              Welcome to Inseed University
            </h1>
            <p className="text-gray-600 mb-4">
              At Inseed University, we are committed to nurturing the
              intellectual and personal growth of our students. Our academic
              programs are designed to inspire creativity, critical thinking,
              and a passion for learning.
            </p>
            <p className="text-gray-600 mb-4">
              Our campus is a vibrant community where students from diverse
              backgrounds come together to collaborate and innovate. With
              state-of-the-art facilities and a supportive environment, Inseed
              University provides an ideal setting for academic excellence and
              personal development.
            </p>
            <p className="text-gray-600">
              Join us at Inseed University, where you can explore new ideas,
              develop your skills, and prepare for a successful future. Our
              dedicated faculty and staff are here to guide and support you
        ...
        <section className="bg-white bg-opacity-75 p-6 rounded-lg shadow-lg mb-8 flex flex-col items-center text-center">
          ...
          />
          <p className="text-gray-600">
            Explore the possibilities of an Inseed University education.
          </p>
        ...
        <section className="bg-white bg-opacity-75 p-6 rounded-lg shadow-lg mb-8 flex flex-col md:flex-row items-center md:items-start">
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-600 mb-4">
              Undergraduate Admission About 1,700 freshmen and 30 transfer
              students enroll at Stanford each year. We review each applicant
              with an eye to academic excellence, intellectual vitality, and
              personal context.
            </p>
            <p className="text-gray-600">
              Undergraduate Financial Aid Stanford meets the full financial need
              of every admitted undergrad who qualifies for assistance. Tuition
              is covered for undergrads with family incomes under $150,000.
              Tuition, room, and board are covered for undergrads with family
