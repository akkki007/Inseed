...
const AlumniCard = () => {
  return (
    ...
    >
      <header
        className={`backdrop-blur-lg bg-white bg-opacity-65 flex items-center justify-between p-4 bg-white ${shadowClasses}`}
      >
      ...
      <main className=" space-y-8 mt-8">
        <section
          className={`backdrop-blur-lg bg-white bg-opacity-65 flex flex-col md:flex-row items-center bg-white text-black p-8 space-y-4 md:space-y-0 md:space-x-4 ${shadowClasses}`}
        >
        ...
        <section
          className={`backdrop-blur-lg bg-white bg-opacity-65 bg-white text-black p-8 ${shadowClasses}`}
        >
          <div
